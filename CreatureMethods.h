...
namespace LuaCreature
{
...
#ifdef MANGOS
        Eluna::Push(L, creature->GetCharmInfo()->HasReactState((ReactStates)state));
#else
        Eluna::Push(L, creature->HasReactState((ReactStates)state));
#endif
        return 1;
    }
    ...
    {
#ifdef MANGOS
        Eluna::Push(L, creature->GetCharmInfo()->GetReactState());
#else
        Eluna::Push(L, creature->GetReactState());
#endif
        return 1;
    }
